...
async def upscale(ctx):
    ...
    try:
        ...
        print(msg_attachment_url)
        if msg_attachment_url[-4:] == ".png" or ".jpg":
            file_ext = msg_attachment_url[-4:]
        elif msg_attachment_url[-5:] == ".jpeg" or ".mpeg":
        ...
        w2x = subprocess.run(
            r"{} -v -i {} -o {} -n 2 -s 2 -g 0".format(w2x_exec_path, cache_path + r"/" + file_name + file_ext, cache_path + r"/" + file_name + f"-O{file_ext}"),
